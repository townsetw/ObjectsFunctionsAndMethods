...
#              The (0,0) point on the screen is located in the top left hand
#  corner of the rose graphics window.
#
#        -- In what direction on the screen does the positive X-axis point?
#              To the right of the rose graphics window.
#
...
#            window2 = rg.RoseWindow(5000,100)
#
...
#            The RoseWindowRENDER method makes the rosegraphics window show
# the stuff attached to it
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            A RoseWindow close_on_mouse_click method is a quick and easy
# way to exit the graphics window/function of code.
#
